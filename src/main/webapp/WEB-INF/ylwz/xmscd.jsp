...
<div class="content_color">
    <div id="content">
        <div class="content_left">
            <div class="content_left2" style="margin-top: 0"><img src="${ctx}/static/ylwz/images/xmsl_01.jpg" alt=""></div>
            <div class="content_left2"><img src="${ctx}/static/ylwz/images/xmsl_02.jpg" alt=""></div>
        </div>
