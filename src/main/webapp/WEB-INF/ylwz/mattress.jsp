...
<div class="banner">
    <img  src="${ctx}/static/ylwz/images/banner3.jpg" alt="">
</div>
<div class="content_color">
    <div id="content">
        <div class="content_left">
            <div class="content_left2" style="margin-top: 0"><img src="${ctx}/static/ylwz/images/cdl_01.jpg" alt=""></div>
            <div class="content_left2"><img src="${ctx}/static/ylwz/images/cdl_02.jpg" alt=""></div>
        </div>
        <div class="content_right">
            <div style="height: 5px"></div>
            <div class="content_rightl">
                <a href="${ctx}/ylwz/cp" target="_blank"><img src="${ctx}/static/ylwz/images/cdr_01.jpg" alt=""></a>
                <div class="prdtitle">泰国天然橡胶乳胶床垫</div>
            ...
            <div class="content_right2">
                <a href="${ctx}/ylwz/article" target="_blank"><img src="${ctx}/static/ylwz/images/cdr_02.jpg" alt=""></a>
                <div class="prdtitle">泰国天然橡胶乳胶床垫</div>
                <div class="prdtext">100%纯实 绿色环保 零甲醛 自带万向轮</div>
                <div class="prdbuy">
                    <span class="m1">¥</span>
            ...
            <div class="content_rightl">
                <a href="${ctx}/ylwz/cp" target="_blank"><img src="${ctx}/static/ylwz/images/cdr_03.jpg" alt=""></a>
                <div class="prdtitle">泰国天然橡胶乳胶床垫</div>
                <div class="prdtext">100%纯实 绿色环保 零甲醛 自带万向轮</div>
                <div class="prdbuy">
                    <span class="m1">¥</span>
            ...
            <div class="content_right2">
                <a href="${ctx}/ylwz/cp" target="_blank"><img src="${ctx}/static/ylwz/images/cdr_04.jpg" alt=""></a>
                <div class="prdtitle">泰国天然橡胶乳胶床垫</div>
                <div class="prdtext">100%纯实 绿色环保 零甲醛 自带万向轮</div>
                <div class="prdbuy">
                    <span class="m1">¥</span>
