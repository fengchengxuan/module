...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/xwyz/css/publish.css" type="text/css">
</head>
<body>
        ...
        <div style="float: left">
            <div class="contentbox">
                ...
                <div class="inner" style="height: 1364px;width: 985px">
                    <label>
                    <select name="" id="" class="articleselect">
                        <option value="" style="padding: 10px">选择发布文章类型</option>
                        <option value="">导航一</option>
                        <option value="">导航二</option>
                        <option value="">导航三</option>
                        <option value="">导航四</option>
                        <option value="">导航五</option>
                        <option value="">导航六</option>
                        <option value="">导航七</option>
                        <option value="">导航八</option>
                        <option value="">导航九</option>
                        <option value="">导航十</option>
                        <option value="">导航十一</option>
                        <option value="">导航十二</option>
                        <option value="">导航十三</option>
                        <option value="">导航十四</option>
                        <option value="">导航十五</option>
                    </select>
                    </label>
...
<jsp:include page="/WEB-INF/xwyz/comm/footer.jsp"/>
    ...
    <script type="text/javascript" charset="utf-8" src="${ctx}/static/xwyz/editor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="${ctx}/static/xwyz/editor/ueditor.all.js"></script>
    <script type="text/javascript" charset="utf-8" src="${ctx}/static/xwyz/editor/lang/zh-cn/zh-cn.js"></script>
    <script src="${ctx}/static/xwyz/editor/ueditor.parse.js" type="text/javascript"></script>
    <script src="${ctx}/static/xwyz/js/jquery-1.11.3.js" type="text/javascript"></script>
    <script src="${ctx}/static/xwyz/js/md5.js" type="text/javascript"></script>
