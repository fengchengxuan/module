...
var tab01=document.getElementById("demo01");
var tab02=document.getElementById("demo02");
...
var MyMar1=setInterval(Marquee1,speed0);
tab0.onmouseover=function() {clearInterval(MyMar1)};
tab0.onmouseout=function() {MyMar1=setInterval(Marquee1,speed0)};
...
//滚动图片
var $preview = $('.preview p');
var $preview2 = $('.preview2 p');
